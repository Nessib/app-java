pipeline {
  ...
  stages {
    ...
    stage('Email Notification') {
      steps {
        emailext(subject: 'Échec du pipeline Jenkins', body: 'Il y a eu un échec dans le pipeline Jenkins. Veuillez vérifier et résoudre le problème.', to: 'necibmakrem25@gmail.com', attachLog: true)
      }
    }
